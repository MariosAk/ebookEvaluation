...
{    
    ...
    var inter = setInterval(function(){
        if(imageExists(image1)){
            ...
            document.getElementById("firstImage").src = image1;
            //var node = document.getElementById("link1");
            //node.innerHTML = alt;//document.getElementById("alternUrl").value;
            //node.setAttribute('href', document.getElementById("alternUrl").value);
            setButtons(false);	
			b=document.getElementById('bool');
		    b.value=1;
...
{    
    ...
    var inter = setInterval(function(){
        if(imageExists(image1)){	
            ...
            //node.innerHTML = document.getElementById("alternUrl").value;
            //node.setAttribute('href', document.getElementById("alternUrl").value);
            setButtons(false);	
...
function end(v1)
{
	...
	document.getElementById('brokenLeft').style.visibility = 'hidden';
	document.getElementById('brokenRight').style.visibility = 'hidden';
	/*document.getElementById('textLocal').style.visibility='hidden';
	document.getElementById('textTotal').style.visibility='hidden';
	document.getElementById('localCounter').style.visibility='hidden';
	document.getElementById('totalCounter').style.visibility='hidden';
	document.getElementById('outOf').style.visibility='hidden';*/
...
document.getElementById('yes').style.visibility = 'hidden';
document.getElementById('no').style.visibility = 'hidden';
//window.onbeforeunload=postTest();
